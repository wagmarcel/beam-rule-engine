...
public class RuleSideInputTransform extends DoFn<KV<String, String>, Map<String, List<Rule>>>{


    private final RulesApi rulesApi;
    private Map<String, List<Rule>> componentsRules;
    private static final Logger LOG = LogHelper.getLogger(RuleSideInputTransform.class);
    public RuleSideInputTransform(Config userConfig) {
        this(userConfig, new DashboardRulesApi(new DashboardConfigProvider(userConfig)));
    }

    public RuleSideInputTransform(Config userConfig, RulesApi rulesApi) {
