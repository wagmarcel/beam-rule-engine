...
public class GetComponentWithRulesTransformation extends DoFn<List<Observation>, List<RulesWithObservation>> {
    ...
    private PCollectionView<Map<String, List<Rule>>> si;

    private RulesRepository rulesRepository;

    public GetComponentWithRulesTransformation(Config userConfig, PCollectionView<Map<String, List<Rule>>> sideinput) {
        this(userConfig, new RulesHbaseRepository(userConfig));
        si = sideinput;
    }

    public GetComponentWithRulesTransformation(Config userConfig, RulesRepository rulesRepository) {
    ...
    public void processElement(ProcessContext c) {
        try {
            ...
            Map<String, List<Rule>> side = c.sideInput(si);
